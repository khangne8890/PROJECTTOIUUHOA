...
def main():
    ...
    st.markdown("**Đồ án Tối Ưu Hóa** | Sinh viên thực hiện: Mạc Minh Khang, Nguyễn Đăng Khoa")
    st.markdown("---")
    ...
    with col1:
        ...
        df_tw = pd.DataFrame(time_windows, columns=["Mở cửa sớm nhất", "Đóng cửa trễ nhất"], 
